          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav ms-auto">
              <li className="nav-item active">
                <a className="nav-link" href="https://nickdammy.github.io/homepage/about" style={{color:"white"}} >About Me</a>
              </li>
              ...
              <li className="nav-item">
                <a style={{color:"white"}} className="nav-link disabled" href="#">Contact Me</a>
              </li>
            </ul>
            </div>
          </div>
